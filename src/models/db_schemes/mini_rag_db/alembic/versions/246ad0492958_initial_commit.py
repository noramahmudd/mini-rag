...
Revision ID: 246ad0492958
Revises: 
Create Date: 2026-07-03 18:22:58.991248
...
def upgrade() -> None:
    ...
    op.create_index('ix_asset_project_id_index_1', 'assets', ['asset_project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_asset_project_id_index_1', table_name='assets')
